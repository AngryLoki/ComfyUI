...
class CpuIpexMode(enum.Enum):
    ...
    Yes = "yes"
    No = "no"
parser.add_argument("--use-ipex", type=CpuIpexMode, default=CpuIpexMode.Auto, help="Use IPEX for CPU. \"auto\" checks if it is installed and does not degrade performance.", action=EnumAction)
